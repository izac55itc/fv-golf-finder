export const COURSES = [
  ...
  { id: 'newlands-cc',         name: 'Newlands Golf & CC',              holes: 18, type: 'regulation', par: 71, lat: 49.0922, lng: -122.5889, avgHoleMinutes: 14, baseGreenfee: 75,  golfnowId: 3525,  golfnowSlug: '3525-newlands-golf-country-club' },
  { id: 'newlands-executive',  name: 'Newlands Executive',              holes: 9,  type: 'executive',  par: 31, lat: 49.0922, lng: -122.5889, avgHoleMinutes: 12, baseGreenfee: 35,  golfnowId: 11039, golfnowSlug: '11039-newlands-golf-country-club-executive-11-hole' },
  ...
  { id: 'eighteen-pastures',   name: 'Eighteen Pastures Golf Course',   holes: 18, type: 'regulation', par: 72, lat: 49.1891, lng: -122.3387, avgHoleMinutes: 14, baseGreenfee: 45,  golfnowId: 3530,  golfnowSlug: '3530-eighteen-pastures-golf-course' },

  // ── Surrey ───────────────────────────────────────────────────────────
  { id: 'westfield',           name: 'Westfield Country Club',          holes: 9,  type: 'executive',  par: 31, lat: 49.1389, lng: -122.7544, avgHoleMinutes: 11, baseGreenfee: 30,  golfnowId: 6629,  golfnowSlug: '6629-westfield-country-club' },

  // ── Pitt Meadows ─────────────────────────────────────────────────────
  { id: 'golden-eagle-north',  name: 'Golden Eagle Golf Club - North',  holes: 18, type: 'regulation', par: 72, lat: 49.2935, lng: -122.6168, avgHoleMinutes: 14, baseGreenfee: 65,  golfnowId: 3515,  golfnowSlug: '3515-golden-eagle-north' },
  { id: 'golden-eagle-south',  name: 'Golden Eagle Golf Club - South',  holes: 18, type: 'regulation', par: 70, lat: 49.2930, lng: -122.6165, avgHoleMinutes: 14, baseGreenfee: 55,  golfnowId: 15899, golfnowSlug: '15899-golden-eagle-south' },
