export const COURSES = [
  ...
  { id: 'newlands-exec',      name: 'Newlands Executive',             holes: 9,  type: 'executive',  par: 31, lat: 49.0856, lng: -122.5840, avgHoleMinutes: 12, baseGreenfee: 35,  golfnowId: null  },
  ...
  { id: 'golden-eagle',       name: 'Golden Eagle Golf Club',         holes: 18, type: 'regulation', par: 72, lat: 49.2634, lng: -122.7123, avgHoleMinutes: 14, baseGreenfee: 65,  golfnowId: null  },
  { id: 'swaneset-cc',        name: 'Swaneset Bay Resort & CC',       holes: 18, type: 'regulation', par: 72, lat: 49.2890, lng: -122.7456, avgHoleMinutes: 14, baseGreenfee: 85,  golfnowId: 19887 },
  { id: 'swaneset-exec',      name: 'Swaneset Executive Course',      holes: 9,  type: 'executive',  par: 31, lat: 49.2895, lng: -122.7460, avgHoleMinutes: 11, baseGreenfee: 35,  golfnowId: null  },
  ...
  { id: 'meadow-gardens-club',name: 'Meadow Gardens Golf Club',       holes: 18, type: 'regulation', par: 72, lat: 49.2230, lng: -122.7885, avgHoleMinutes: 14, baseGreenfee: 75,  golfnowId: null  },
  ...
  { id: 'eighteen-pastures',  name: 'Eighteen Pastures Golf Course',  holes: 18, type: 'regulation', par: 72, lat: 49.1234, lng: -122.4567, avgHoleMinutes: 14, baseGreenfee: 45,  golfnowId: null  },
...
// Courses with known GolfNow facility IDs — scraped by the DO server
