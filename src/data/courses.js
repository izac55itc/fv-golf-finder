export const COURSES = [
  // ── Langley ──────────────────────────────────────────────────────────
  { id: 'fort-langley',        name: 'Fort Langley Golf Course',       holes: 9,  type: 'regulation', par: 35, lat: 49.1684, lng: -122.5750, avgHoleMinutes: 14, baseGreenfee: 28,  cartFee: 15,  cartNote: null,              cartRequired: true, golfnowId: 3524,  bookingUrl: 'https://fortlangley.cps.golf/onlineresweb/search-teetime' },
  { id: 'belmont',             name: 'Belmont Golf Course',             holes: 18, type: 'regulation', par: 71, lat: 49.1123, lng: -122.6234, avgHoleMinutes: 14, baseGreenfee: 45,  cartFee: 15,  cartNote: null,              cartRequired: true, golfnowId: 358,   golfnowSlug: '358-belmont-golf-course' },
  { id: 'newlands-cc',         name: 'Newlands Golf & CC',              holes: 18, type: 'regulation', par: 71, lat: 49.0922, lng: -122.5889, avgHoleMinutes: 14, baseGreenfee: 75,  cartFee: 22,  cartNote: null,              cartRequired: false, golfnowId: 3525,  golfnowSlug: '3525-newlands-golf-country-club' },
  ...
  { id: 'redwoods',            name: 'The Redwoods Golf Course',        holes: 18, type: 'regulation', par: 72, lat: 49.0234, lng: -122.5456, avgHoleMinutes: 14, baseGreenfee: 55,  cartFee: 15,  cartNote: null,              cartRequired: true, golfnowId: null, bookingUrl: 'https://www.redwoods-golf.com/online-booking' },
  ...
  // ── Pitt Meadows ─────────────────────────────────────────────────────
  { id: 'golden-eagle-north',  name: 'Golden Eagle Golf Club - North',  holes: 18, type: 'regulation', par: 72, lat: 49.2935, lng: -122.6168, avgHoleMinutes: 14, baseGreenfee: 65,  cartFee: 27,  cartNote: null,              cartRequired: false, golfnowId: 3515,  golfnowSlug: '3515-golden-eagle-north' },
  ...
  { id: 'swaneset-resort',     name: 'Swaneset Bay Resort Course',      holes: 18, type: 'regulation', par: 72, lat: 49.2734, lng: -122.6423, avgHoleMinutes: 14, baseGreenfee: 85,  cartFee: 20,  cartNote: null,              cartRequired: true, golfnowId: 19887, golfnowSlug: '19887-swaneset-bay-resort-country-club-resort-course' },
  { id: 'swaneset-links',      name: 'Swaneset Bay Links Course',       holes: 18, type: 'regulation', par: 72, lat: 49.2730, lng: -122.6420, avgHoleMinutes: 14, baseGreenfee: 72,  cartFee: 20,  cartNote: null,              cartRequired: true, golfnowId: 301,   golfnowSlug: '301-swaneset-bay-resort-country-club-links-course' },
